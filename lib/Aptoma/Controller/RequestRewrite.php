<?php
/**
 * This will handle the issues with the routing and
 * the use of mod_rewrite and all different URLs and make the following work:
 *
...
class Aptoma_Controller_RequestRewrite extends Zend_Controller_Plugin_Abstract
{
    public function routeStartup(Zend_Controller_Request_Abstract $request)
    {
         ...
         * http://localhost/com.aptoma.drfront/prod/drfront
         *
         * This file is kept as is for now since changeing will mostly create more problem att the
         * customer cause most are using the old AFW way of setting things up.
         */
    }
}
